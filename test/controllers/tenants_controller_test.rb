...
class TenantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post tenants_url, params: { tenant: { account_id: @tenant.account_id, status: @tenant.status, uid: @tenant.uid } }
    end
  ...
  test "should update tenant" do
    patch tenant_url(@tenant), params: { tenant: { account_id: @tenant.account_id, status: @tenant.status, uid: @tenant.uid } }
